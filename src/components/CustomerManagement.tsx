                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <div className="flex items-center gap-4">
                          ...
                          <div className="text-center">
                            <div className="text-lg font-bold text-green-600">{currencySymbol}{(customer.totalSpent ?? 0).toLocaleString()}</div>
                ...
                {getFilteredCustomersForMarketing().map((customer) => (
                  <div key={customer.id} className="flex items-center justify-between p-2 border rounded">
                    ...
                    <div className="text-sm text-muted-foreground">
                      {customer.totalOrders ?? 0} orders • {currencySymbol}{(customer.totalSpent ?? 0).toLocaleString()}
                    </div>
                  </div>
                ))}
              </div>
          ...
          {selectedCustomer && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-4 gap-4 p-4 bg-muted/30 rounded-lg">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600">{currencySymbol}{selectedCustomer.totalSpent?.toLocaleString() || 0}</div>
                  <div className="text-xs text-muted-foreground">Total Spent</div>
                </div>
                <div className="text-center">
                    ...
                    {selectedCustomer.orderHistory.slice(0, 5).map((order: any) => (
                      <Card key={order.id} className="p-3">
                        <div className="flex justify-between items-start text-sm">
                          ...
                          <div className="text-right">
                            <div className="font-bold text-primary">{currencySymbol}{order.amount}</div>
