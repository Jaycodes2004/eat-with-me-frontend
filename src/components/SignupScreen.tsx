...
import { fetchPlans, formatPlansForDisplay } from '../lib/adminPlansApi/adminPlansApi';
				...
				<div className='fixed inset-0 z-50 flex items-center justify-center bg-black/40'>
					<div className='bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full text-center border-2 border-primary'>
						<h2 className='text-2xl font-bold mb-4 text-primary'>
							Your Unique Restaurant ID
						</h2>
						<p className='mb-4 text-muted-foreground'>
							This is your unique Restaurant ID.{' '}
							<span className='font-semibold text-primary'>Keep it safe</span> —
							you will need it to log in and for support.
						</p>
						<div className='mb-6'>
										...
										<div className='space-y-2'>
											...
											<div className='relative'>
												...
												{/* <PhoneInput
													...
													} // value is like "919876543210" or "+919876543210" depending on config
													inputClass='!pl-10 !h-12 !w-full bg-white/50 border-primary/20 focus:border-primary'
													...
													<div className='flex items-start gap-4'>
														<div
															className={`w-12 h-12 rounded-xl bg-gradient-to-r ${
																plan.color || 'from-gray-400 to-gray-600'
														...
														<div className='flex-1'>
																	...
																	<p className='text-xs text-muted-foreground'>
																		{plan.period ??
																			(plan.defaultBillingCycle
																				? plan.defaultBillingCycle.toLowerCase()
																				: 'per month')}
																	</p>
																</div>
															</div>
															...
															<div className='grid grid-cols-1 gap-1'>
																...
																{(!Array.isArray(plan.features) ||
																	plan.features.length === 0) &&
																	!Array.isArray(plan.featureHighlights) &&
																	Array.isArray(plan.allowedModules) &&
																	plan.allowedModules
																		.slice(0, 5)
